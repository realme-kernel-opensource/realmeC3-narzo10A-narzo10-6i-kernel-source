...
## Description : add for project phoenix(hang oppo)
##               PHOENIX_PROJECT
##
##
## Version:  1.0
...
## Kun Hu         2019/06/12       refactoring phoenix kernel base
################################################################################
*/
...
static void phx_handle_hang_oppo(const char *);
...
static phx_action_mapping errno_handle_action_mapping[] = {
    ...
    {ERROR_HANG_OPPO, phx_handle_hang_oppo},
...
static void phx_handle_hang_oppo(const char *happen_time)
{
    phx_klog_booterror(ERROR_HANG_OPPO, happen_time);
    phx_log_dump(ERROR_HANG_OPPO);
}
