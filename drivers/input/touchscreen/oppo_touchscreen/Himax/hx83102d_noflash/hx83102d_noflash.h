...
#ifndef HX83102D_NOFLASH_H
#define HX83102D_NOFLASH_H
...
#define EXTEND_EE_SHORT_TEST_LIMIT_PART2	80
...
struct chip_data_hx83102d {
    uint32_t *p_tp_fw;
    tp_dev tp_type;
    /*hx83102d func provide to hx83102d common driver*/
    ...
    uint8_t *tmp_data;
    /*show touchpanel current direction*/
...
struct himax_core_fp {
    ...
    void (*fp_write_sram_0f)(const struct firmware *fw_entry, uint8_t *addr,
...
#ifdef HX_0F_DEBUG
    void (*fp_read_sram_0f)(const struct firmware *fw_entry, uint8_t *addr,
