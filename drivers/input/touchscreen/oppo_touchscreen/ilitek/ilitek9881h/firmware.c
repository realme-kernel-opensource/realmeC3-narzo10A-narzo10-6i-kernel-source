...
void core_firmware_get_project_h_file_data(void)
{
	...
	if (do_once == 0) {
		...
		if (is_project(OPPO_18571) || is_project(OPPO_18171) || is_project(OPPO_18172)) {
			static unsigned char CTPM_FW_18171[] = {
				#include "FW_NF_ILI9881H_INNOLUX_18171.ili"
			};
			TPD_INFO("sizeof(CTPM_FW_18171) = 0x%X\n", (int)sizeof(CTPM_FW_18171));
			memcpy(CTPM_FW, CTPM_FW_18171, sizeof(CTPM_FW_18171));
		}
		else {
