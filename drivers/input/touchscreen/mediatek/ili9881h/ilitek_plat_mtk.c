...
struct upgrade_ili_fw_info ili_fw_list[] = {
	{XL_AUO, "TRULY", fw_xl_auo,(int)sizeof(fw_xl_auo), REQUEST_XL_AUO_FW_PATH,FILP_OPEN_XL_AUO_FW_PATH,XL_AUO_ILITEK_INI_PATH,OPPO_SIGN_XL_AUO_FW_PATH},
	{TXD_AUO, "TXD", fw_txd_auo, (int)sizeof(fw_txd_auo),REQUEST_TXD_AUO_FW_PATH,FILP_OPEN_TXD_AUO_FW_PATH,TXD_AUO_ILITEK_INI_PATH,OPPO_SIGN_TXD_AUO_FW_PATH},
};
...
//Bo.Zhang@ODM_WT.BSP.Touchscreen.funtion,2019/11/04,add ftm mode.
