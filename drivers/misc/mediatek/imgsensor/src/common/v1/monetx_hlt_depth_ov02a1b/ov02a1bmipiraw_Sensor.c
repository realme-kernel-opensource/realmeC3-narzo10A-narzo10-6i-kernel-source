...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = MONETX_HLT_DEPTH_OV02A1B_SENSOR_ID,
	...
	.custom1 = {
		.pclk = 39000000,
		.linelength  = 934,
		.framelength = 1740,//1390,30;1739,24
		.startx = 0,
		.starty = 0,
		.grabwindow_width  = 1600,
		.grabwindow_height = 1200,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3f, 0x00); /*Zhen.Quan@ODM_WT.CAMERA.Driver.2019/10/23,modify for camera flip*/
}	/*	sensor_init  */
...
static kal_uint32 open(void)
{
	...
	LOG_INF("ov02a1b PLATFORM:Vison,MIPI 1LANE\n");
