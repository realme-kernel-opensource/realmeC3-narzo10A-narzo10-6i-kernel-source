...
#define ENABLE_OV12A10_MONETD_OTP 1
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MONETD_TRULY_OV12A10_SENSOR_ID,
...
//normal-video
	...
	8,    8, 4096, 3072,    0,    0, 4096, 3072},
//hs-video
	{4112, 3088,   0,   0, 4112,   3088,   1028,
        772,  192, 144,   640,  480,  0,   0,    640,  480},/*yang.guo@ODM_WT.Camera.hal, 2019/12/21, mod customer setting  for hs video cam  */
//slim-video
	{ 4112, 3088,  0, 0, 4112,   3088,   2056,  1544,
	4, 4,  2048,  1536,  0,   0,   2048,  1536},
//custom1
...
static void write_shutter(kal_uint32 shutter)
{
    ...
    if(shutter > imgsensor_info.max_frame_length){//max_frame_length 7FFF
        ...
        imgsensor.ae_frm_mode.frame_mode_1 = IMGSENSOR_AE_MODE_SE; /*default,  Expoaure mode of LE frame + 1 */
        imgsensor.ae_frm_mode.frame_mode_2 = IMGSENSOR_AE_MODE_SE; /*default,  Expoaure mode of LE frame + 2 */
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_ov12a10[] = {
	0x0103, 0x01,
	0x0302, 0x49,
	0x0303, 0x00,
	0x0304, 0x00,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_ov12a10[] = {
	0x3631, 0x00,
	0x3642, 0x10,
	0x3666, 0x08,
	0x366b, 0x20,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_15fps_ov12a10[] = {
	0x3631, 0x00,
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
...
static kal_uint16 addr_data_pair_capture_24fps_ov12a10[] = {
	0x3631, 0x00,
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
...
static kal_uint16 addr_data_pair_capture_30fps_ov12a10[] = {
	0x3631, 0x30,
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
...
static  kal_uint16 addr_data_pair_hs_video_ov12a10[] = {
        0x3642,0x08,
        0x3666,0x08,
        0x366b,0x20,
        0x366c,0xa4,
...
//*yaoguizhen@ODM_WT.Camera.hal, 2019/11/21, add customer setting  for dual cam start */
#if MULTI_WRITE
static kal_uint16 addr_data_pair_custom2_24fps_ov12a10[] = {
	0x3631, 0x00,
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
