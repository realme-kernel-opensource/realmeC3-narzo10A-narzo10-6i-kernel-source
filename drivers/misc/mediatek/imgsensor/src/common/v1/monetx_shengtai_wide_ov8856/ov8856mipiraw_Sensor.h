...
struct imgsensor_info_struct {
	...
	//*yaoguizhen@ODM_WT.Camera.hal, 2019/11/21, add customer setting  for dual cam */
	struct imgsensor_mode_struct
	    custom1; /*slim video for VT scenario relative information*/
	struct imgsensor_mode_struct
	    custom2; /*slim video for VT scenario relative information*/
	struct imgsensor_mode_struct
	    custom3; /*slim video for VT scenario relative information*/
	//*yaoguizhen@ODM_WT.Camera.hal, 2019/11/21, add customer setting  for dual cam */
