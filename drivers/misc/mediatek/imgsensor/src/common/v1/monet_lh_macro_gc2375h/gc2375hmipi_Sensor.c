...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MONET_LH_MACRO_GC2375H_SENSOR_ID,
	.checksum_value = 0x8726c936,
	.pre = {
		.pclk = 42000000,/* 45500000->42000000 desense jeremy 20191212*/
		.linelength = 1169,/* 1040->1169 desense jeremy 20191212*/
		.framelength = 1240,/* 1500->1240 desense jeremy 20191212 */
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1600,
		.grabwindow_height = 1200,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 67200000,/* 72800000->67200000 desense jeremy 20191212*/
		.max_framerate = 300,
	},
	.cap = {
		.pclk = 42000000,/* 45500000->42000000 desense jeremy 20191212*/
	...
	/*Xiaojun.Pu@ODM_WT.Camera.Driver.493476, 2019/10/28, modify mclk driving current */
...
{
	return ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 1;/*Duilin.Qin@ODM_WT.Camera.Driver, 2019/10/30, modify by fae*/
}
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xf7, 0x01);/* 0x03->0x01 desense jeremy 20191212 */
	write_cmos_sensor(0xf8, 0x0d);/* 0x1b->0x0d desense jeremy 20191212*/
	...
	write_cmos_sensor(0x06, 0xdb);/* 0x5a->0xdb desense jeremy 20191212*/
	write_cmos_sensor(0x07, 0x00);/* 0x01->0x00 desense jeremy 20191212 */
	write_cmos_sensor(0x08, 0x10);/* 0x14->0x10 desense jeremy 20191212 */
	...
	write_cmos_sensor(0x1c, 0x10);/* 0x18->0x10 desense jeremy 20191212 */
	...
	write_cmos_sensor(0x21, 0x0a);/* 0x08->0x0a desense jeremy 20191212*/
	write_cmos_sensor(0x22, 0x05);
	write_cmos_sensor(0x23, 0x16);/* 0x13->0x16 desense jeremy 20191212*/
	write_cmos_sensor(0x24, 0x02);
	write_cmos_sensor(0x25, 0x16);/* 0x13->0x16 desense jeremy 20191212*/
	write_cmos_sensor(0x26, 0x07);/* 0x08->0x07 desense jeremy 20191212*/
	write_cmos_sensor(0x29, 0x06);
	write_cmos_sensor(0x2a, 0x08);
	write_cmos_sensor(0x2b, 0x07);/* 0x08->0x07 desense jeremy 20191212*/
	write_cmos_sensor(0xfe, 0x00);
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(!check_otp_data(&monet_lh_macro_gc2375h_eeprom_data, monet_lh_macro_gc2375h_checksum, sensor_id)){
					break;
				} else {
					/*xiaojun.Pu@Camera.Driver, 2019/10/15, add for [add hardware_info for factory]*/
					hardwareinfo_set_prop(HARDWARE_MONO_CAM_MOUDULE_ID, "Lh");
				}
#endif
