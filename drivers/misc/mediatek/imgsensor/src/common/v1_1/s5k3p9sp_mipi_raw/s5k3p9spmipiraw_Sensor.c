					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if(g_is_project_18561 == KAL_TRUE){
		...
		imgsensor.min_frame_length = 2608;
	}else{
...
static kal_uint32 set_max_framerate_by_scenario(enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
	...
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		if(framerate == 0)
			return ERROR_NONE;
		if(g_is_project_18561 == KAL_TRUE){
			frame_length = imgsensor_info.normal_video.pclk / framerate * 10 / 7152;
		}else{
			frame_length = imgsensor_info.normal_video.pclk / framerate * 10 / imgsensor_info.normal_video.linelength;
		}
		spin_lock(&imgsensor_drv_lock);
		if(g_is_project_18561 == KAL_TRUE){
			imgsensor.dummy_line = (frame_length > 2608) ? (frame_length - 2608) : 0;
			imgsensor.frame_length = 2608 + imgsensor.dummy_line;
		}else{
