...
static imgsensor_struct imgsensor = {
	...
	.i2c_write_id = 0x20,
#ifdef VENDOR_EDIT
	/*Chengtian.Ding@Camera, 2019-01-30 add for 18531 n+2 long exposure*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] =
{
	...
	{4000, 3000, 80, 420, 3840, 2160, 1920, 1080, 0000, 0000, 1920, 1080, 0, 0, 1920, 1080},	/* hight speed video */
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if (shutter >= 0xFFF0) {  // need to modify line_length & PCLK
		...
		/*Chengtian.Ding@Camera, 2018-01-29 add for 18531 n+2 long exposure*/
		imgsensor.current_ae_effective_frame = 2;
	}
	#endif
...
//UINT32 IMX214_MIPI_SensorInit(struct PSENSOR_FUNCTION_STRUCT *pfFunc)
{
