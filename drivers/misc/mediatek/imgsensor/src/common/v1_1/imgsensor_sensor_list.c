...
/*Caohua.Lin@Camera.Driver 20180723 add for imgsensor driver*/
...
#endif
#if defined(IMX371_MIPI_RAW)
	{IMX371_SENSOR_ID, SENSOR_DRVNAME_IMX371_MIPI_RAW, IMX371_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(S5K4H7_MIPI_RAW2)
        {S5K4H7_SENSOR_ID, SENSOR_DRVNAME_S5K4H7_MIPI_RAW2,S5K4H7_MIPI_RAW2_SensorInit},
#endif
#if defined(OV02A10_MIPI_RAW)
       {OV02A10_SENSOR_ID, SENSOR_DRVNAME_OV02A10_MIPI_RAW, OV02A10_MIPI_RAW_SensorInit},
#endif
	...
	{S5K3P9SX_SENSOR_ID, SENSOR_DRVNAME_S5K3P9SX_MIPI_RAW, S5K3P9SX_MIPI_RAW_SensorInit},
#endif
