...
static struct LCM_setting_table lcm_initialization_cmd_setting[] = {
	...
	{0xB0, 1, {0x01}},
	{0xBB, 1, {0x03}},
	{0xEF, 7, {0xB0,0x31,0x00,0x33,0x31,0x14,0x35}},
	{REGFLAG_DELAY, 10, {}},
	{0x53, 1, {0x20}},
	{0x38, 1, {0x00}},
	{0x51, 2, {0x00,0x00}},
	...
	{0xE2, 2, {0x00,0x85}},
	{0xB0, 1, {0x2C}},
	{0xE2, 21, {0xB0,0x03,0x05,0x04,0xFF,0x00,0x00,0x00,0xFF,0x00,0xFF,0xFF,0xF2,0x00,0xF2,0xE4,0xDB,0x14,0xFC,0xFD,0xFF}},
	{0xB0, 1, {0x49}},
	{0xE2, 1, {0x00}},
	{0xB0, 1, {0x4A}},
	{0xE2, 1, {0x00}},
...
#ifndef BUILD_LK
	register_device_proc("lcd", "SOFEG01_S-MTK01", "samsung1024 cmd mode");
#endif
}
...
struct LCM_DRIVER oppo_samsung_ams628nw_1080p_dsi_cmd_lcm_drv=
{
	.name = "oppo_samsung_ams628nw_1080p_dsi_cmd",
