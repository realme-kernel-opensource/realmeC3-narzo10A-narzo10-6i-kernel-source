...
*/
	register_device_proc("lcd", "td4330_m03", "tianma cmd mode");
#endif
}
...
struct LCM_DRIVER oppo18531_tianma_td4330_1080p_dsi_cmd_lcm_drv =
{
    .name = "oppo18531_tianma_td4330_1080p_dsi_cmd",
