...
** VENDOR_EDIT
** File: - oppo_tianma_nt36672_1080p_dsi_vdo.c
...
#ifdef VENDOR_EDIT
/*
* Liping-m@PSW.MM.Display.LCD.Stability, 2018/05/23, add for 18311&18011 lcd
*/
...
#define FRAME_18311_HEIGHT (2340)
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    if ( is_project(18311) || is_project(18011) ) {
        params->height = FRAME_18311_HEIGHT;
    } else {
	...
	*/
#ifndef BUILD_LK
	register_device_proc("lcd", "nt36672", "tianma vdo mode");
#endif
}
...
struct LCM_DRIVER oppo_tianma_nt36672_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo17331_tianma_nt36672_1080p_dsi_vdo",
