...
** VENDOR_EDIT
** File: - oppo_jdi_nt36672_1080p_dsi_vdo.c
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	*/
#ifndef BUILD_LK
	register_device_proc("lcd", "nt36672", "jdi vdo mode");
#endif
}
...
{
	LCD_DEBUG("[jdi] lcm_suspend_power\n");
	lcd_rst_setting(0);
	MDELAY(6);
...
{
	LCD_DEBUG("[jdi] lcm_resume_power \n");
	lcm_init_power();
}

static void poweroff_after_ulps(void)
{
	LCD_DEBUG("[lcd] poweroff_after_ulps jdi nt36672 1.8\n");
	lcd_1p8_en_setting(0);
}

static void lcm_init(void)
{
	LCD_DEBUG("[jdi]lcm_initialization_setting\n");
...
struct LCM_DRIVER oppo_jdi_nt36672_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo17331_jdi_nt36672_1080p_dsi_vdo",
