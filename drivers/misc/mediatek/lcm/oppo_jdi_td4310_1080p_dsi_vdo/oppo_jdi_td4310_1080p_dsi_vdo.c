...
static struct LCM_setting_table lcm_initialization_video_setting[] = {
	...
	{REGFLAG_DELAY, 100, {}},
	{0xB0,1,{0x04}},
	{0xCE,25,{0x75,0x40,0x49,0x53,0x59,0x5E,0x63,0x68,0x6E,0x74,0x7E,0x8A,0x98,0xA8,0xBB,0xD0,0xFF,0x01,0x70,0x04,0x04,0x42,0x00,0x69,0x5A}},
	/* cabc setting */
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	*/
#ifndef BUILD_LK
	register_device_proc("lcd", "td4310", "jdi 0328 vdo mode");
#endif
}
...
{
	LCD_DEBUG("[lcd] poweroff_after_ulps 1.8\n");
...
struct LCM_DRIVER oppo_jdi_td4310_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo_jdi_td4310_1080p_dsi_vdo",
