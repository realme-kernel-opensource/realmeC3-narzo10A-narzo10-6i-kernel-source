...
** VENDOR_EDIT
** File: - oppo18561_dpt_jdi_td4330_1080p_dsi_vdo.c
...
*/
	register_device_proc("lcd", "td4330_m04", "dpt cmd mode");
#endif
}
...
struct LCM_DRIVER oppo18561_dpt_jdi_td4330_1080p_dsi_cmd_lcm_drv =
{
    .name = "oppo18561_dpt_jdi_td4330_1080p_dsi_cmd",
