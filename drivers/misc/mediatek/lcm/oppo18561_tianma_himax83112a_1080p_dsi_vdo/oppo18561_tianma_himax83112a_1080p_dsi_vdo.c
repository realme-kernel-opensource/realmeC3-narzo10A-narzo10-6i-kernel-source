...
** VENDOR_EDIT
** File: - oppo18561_tianma_himax83112a_1080p_dsi_vdo.c
...
static struct LCM_setting_table lcm_initialization_video_setting[] = {
	...
	{REGFLAG_DELAY, 130, {}},
	{0xC0,2, {0x22,0x22}},
	{0xC9,4, {0x04,0x08,0xCC,0x01}},
	/* TE ON */
	{0x35,1, {0x00}},
	{0x55,1, {0x01}},
	{REGFLAG_DELAY, 5, {}},
	{0xE9,1,{0xCB}},
	{0xE4,12,{0x8F,0x80,0xAA,0xA5,0xAB,0xB0,0xC8,0xDE,0xFF,0xFF,0xFF,0xEF}},
	{0xE9,1,{0x3F}},
	{0x51,2, {0x0F,0xFF}},
	{REGFLAG_DELAY, 5, {}},
	{0x53,1, {0x24}},
	...
	{0xE9,1,{0xC9}},
	{0xB2,1,{0xDF}},//BIST mode line time
	{0xE9,1,{0x3F}},

	{0xE7,6,{0x0E,0x0E,0x1E,0x61,0x1E,0x61}},//TP time
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch_for_low_power = 537;
...
*/
	ret = register_device_proc("lcd", "hx83112a_m04", "tianma_himax vdo mode");
	if (ret) {
		LCD_DEBUG("register_device_proc tianma hx83112a failed\n");
	}
#endif
}
...
struct LCM_DRIVER oppo18561_tianma_himax83112a_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo18561_tianma_himax83112a_1080p_dsi_vdo",
