...
** VENDOR_EDIT
** File: - oppo_dsjm_nt36672_1080p_dsi_vdo.c
...
**
** ------------------------------- Revision History:---------------
** liping 2018/02/27 1.0 build this module
*******************************************************************/
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	*/
#ifndef BUILD_LK
	register_device_proc("lcd", "nt36672_dsjm", "jdi vdo mode");
#endif
}
...
struct LCM_DRIVER oppo_dsjm_nt36672_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo17331_dsjm_nt36672_1080p_dsi_vdo",
