...
** VENDOR_EDIT
** File: - oppo18531_tm_nt36670a_1080p_dsi_cmd.c
...
*/
	register_device_proc("lcd", "nt36670a_m03", "tianma_nt cmd mode");
#endif
}

static void poweron_before_ulps(void)
{
	LCD_DEBUG("[NT] poweron_before_ulps 1.8v\n");
...
struct LCM_DRIVER oppo18531_tm_nt36670a_1080p_dsi_cmd_lcm_drv =
{
    .name = "oppo18531_tm_nt36670a_1080p_dsi_cmd",
