/*
 * drivers/qihoo/elfload.h for kernel hotfix
 *
...
#define MODULE_VERSION(_version)                                            \
	...
	static const struct module_version_attribute __used __attribute__(  \
	    (__section__("__modver"))) *__moduleparam_const __modver_attr = \
	    &___modver_attr
#endif
...
const struct kernel_symbol *find_symbol(const char *name, struct module **owner,
					const unsigned long **crc, bool gplok,
					bool warn);

/* Walk the exported symbol table */
bool each_symbol_section(bool (*fn)(const struct symsearch *arr,
				    struct module *owner, void *data), void *data);
...
int qh_verify_sig(void *patch, unsigned long plen, void **data,
		  unsigned long *len);
...
struct patch_file {
	int32_t id;  /*repace file id*/
	uint32_t num; /*open file count*/
	char *old_name;
	char *new_name;
