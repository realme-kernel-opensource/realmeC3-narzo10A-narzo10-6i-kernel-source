...
/*
	...
	*/
	...
	if (chg_vol <4300 && low_chg_vol_flag == 0 && !oppo_vooc_get_fastchg_started()) {
...
int bq25890h_reset_charger(void)
{
	...
	rc = bq25890h_config_interface(charger_ic, REG0A_BQ25890H_ADDRESS, 0x72, 0xFF);
	if (rc < 0) {
...
extern int oppo_chg_shortc_hw_parse_dt(struct chip_bq25890h *chip);
struct oppo_chg_operations  bq25890h_chg_ops = {
...
{	
	...
	printk("[OPPO_CHG] do_bq25890h_irq_delay_work flag=%d, val_reg[0x%x]\n", otg_overcurrent_flag, val_reg);
...
static const struct of_device_id bq25890h_match[] = {
	{ .compatible = "oppo,bq25890h-charger"},
	{ },
};
