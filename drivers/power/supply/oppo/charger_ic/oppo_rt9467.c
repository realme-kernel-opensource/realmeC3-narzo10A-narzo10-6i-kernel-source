...
static int rt9467_bc12_hvdcp_workaround(struct rt9467_info *info)
{
	...
	get_monotonic_boottime(&chip->ptime[0]);
	mutex_lock(&info->i2c_access_lock);
	ret = rt9467_toggle_chgdet_flow(info);
	if (ret < 0) {
		dev_notice(info->dev, "%s: fail\n", __func__);
...
static int __rt9467_set_ichg(struct rt9467_info *info, u32 ichg)
{
	...
	u8 reg_ichg = 0;
#if 0
/*Shouli.Wang@ODM_WT.BSP.CHG 2019/12/05, remove 500ma current limit*/
	if (strcmp(info->desc->chg_dev_name, "primary_chg") == 0) {
...
void oppo_rt9467_dump_registers(void)
{
	__rt9467_dump_registers(rt9467);
}

int oppo_rt9467_kick_wdt(void)
{
	return __rt9467_kick_wdt(rt9467);
}

int oppo_rt9467_set_ichg(int cur)
{
	struct oppo_chg_chip *chip = g_oppo_chip;
	u32 uA = cur*1000;
	u32 temp_uA;
...
void oppo_rt9467_set_mivr(int vbatt)
{
...
int oppo_rt9467_set_aicr(int current_ma)
{
	struct oppo_chg_chip *chip = g_oppo_chip;
	int rc = 0, i = 0;
	int chg_vol = 0;
...
int oppo_rt9467_set_cv(int cur)
{
	u32 uV = cur*1000;
	return __rt9467_set_cv(rt9467, uV);
}

int oppo_rt9467_set_ieoc(int cur)
{
	u32 uA = cur*1000;
	return __rt9467_set_ieoc(rt9467, uA);
}

int oppo_rt9467_charging_enable(void)
{
	return __rt9467_enable_charging(rt9467, true);
}

int oppo_rt9467_charging_disable(void)
{
#ifdef ODM_WT_EDIT
...
int oppo_rt9467_hardware_init(void)
{
	int ret = 0;
...
int oppo_rt9467_is_charging_enabled(void)
{
	bool en;
...
int oppo_rt9467_is_charging_done(void)
{
	int ret = 0;
	enum rt9467_charging_status chg_stat = RT9467_CHG_STATUS_READY;
...
int oppo_rt9467_enable_otg(void)
{
	int ret = 0;
...
int oppo_rt9467_disable_otg(void)
{
	int ret = 0;
...
int oppo_rt9467_disable_te(void)
{
	return __rt9467_enable_te(rt9467, false);
}

int oppo_rt9467_get_chg_current_step(void)
{
	return RT9467_ICHG_STEP;
}

int oppo_rt9467_get_charger_type(void)
{
	return charger_type;
}

int oppo_rt9467_charger_suspend(void)
{
	return 0;
}

int oppo_rt9467_charger_unsuspend(void)
{
	return 0;
}

int oppo_rt9467_set_rechg_vol(int vol)
{
	return 0;
}

int oppo_rt9467_reset_charger(void)
{
	return 0;
}
...
void oppo_rt9467_set_chargerid_switch_val(int value)
{
	return;
}

int oppo_rt9467_get_chargerid_switch_val(void)
{
	return 0;
}

int oppo_rt9467_get_charger_subtype(void)
{
	struct charger_manager *info = NULL;
...
bool oppo_rt9467_need_to_check_ibatt(void)
{
	return false;
}

int oppo_rt9467_get_dyna_aicl_result(void)
{
	u32 uA;
	int mA = 0;
...
int oppo_rt9467_set_qc_config(void)
{
#ifdef ODM_WT_EDIT
	//Junbo.Guo@ODM_WT.BSP.CHG, 2019/11/11, Modify for qc
	struct oppo_chg_chip *chip = g_oppo_chip;
...
int oppo_rt9467_enable_qc_detect(void)
{
	return 0;
}

bool oppo_rt9467_get_shortc_hw_gpio_status(void)
{
	return false;
}
...
#ifdef ODM_WT_EDIT
//Junbo.Guo@ODM_WT.BSP.CHG, 2019/11/11, Modify for pe20
int oppo_rt9467_chg_get_pe20_type(void)
{
	struct charger_manager *info = NULL;
...
int oppo_rt9467_chg_pe20_setup(void)
{
	struct charger_manager *info = NULL;
...
int oppo_rt9467_chg_reset_pe20(void)
{
	struct charger_manager *info = NULL;
...
#ifdef ODM_WT_EDIT
//Junbo.Guo@ODM_WT.BSP.CHG, 2019/11/11, Modify for PD
bool oppo_rt9467_get_pd_type(void)
{
	struct charger_manager *info = NULL;
...
int oppo_rt9467_pd_setup (void)
{
	...
	if (chip->limits.vbatt_pdqc_to_5v_thr > 0 && chip->charger_volt > 7500
		...
		oppo_pdc_setup(info,5000);
		rt9467->pdqc_setup_5v = 1;
	}else{
		dev_info(rt9467->dev, "%s:pd Force output 9V\n",__func__);
		oppo_pdc_setup(info,9000);
		rt9467->pdqc_setup_5v = 0;
	}
	
	return true;
}
int oppo_rt9467_chg_set_high_vbus(bool en)
{
	int subtype;
	struct oppo_chg_chip *chip = g_oppo_chip;
	struct charger_manager *info = NULL;
	...
	subtype=oppo_rt9467_get_charger_subtype();
...
struct oppo_chg_operations  oppo_chg_rt9467_ops = {
	.dump_registers = oppo_rt9467_dump_registers,
	.kick_wdt = oppo_rt9467_kick_wdt,
	.hardware_init = oppo_rt9467_hardware_init,
	.charging_current_write_fast = oppo_rt9467_set_ichg,
	.set_aicl_point = oppo_rt9467_set_mivr,
	.input_current_write = oppo_rt9467_set_aicr,
	.float_voltage_write = oppo_rt9467_set_cv,
	.term_current_set = oppo_rt9467_set_ieoc,
	.charging_enable = oppo_rt9467_charging_enable,
	.charging_disable = oppo_rt9467_charging_disable,
	.get_charging_enable = oppo_rt9467_is_charging_enabled,
	.charger_suspend = oppo_rt9467_charger_suspend,
	.charger_unsuspend = oppo_rt9467_charger_unsuspend,
	.set_rechg_vol = oppo_rt9467_set_rechg_vol,
	.reset_charger = oppo_rt9467_reset_charger,
	.read_full = oppo_rt9467_is_charging_done,
	.otg_enable = oppo_rt9467_enable_otg,
	.otg_disable = oppo_rt9467_disable_otg,
	.set_charging_term_disable = oppo_rt9467_disable_te,
	.check_charger_resume = oppo_rt9467_check_charger_resume,

	.get_charger_type = oppo_rt9467_get_charger_type,
	.get_charger_volt = battery_meter_get_charger_voltage,
//	int (*get_charger_current)(void);
	.get_chargerid_volt = NULL,
    .set_chargerid_switch_val = oppo_rt9467_set_chargerid_switch_val,
    .get_chargerid_switch_val = oppo_rt9467_get_chargerid_switch_val,
    ...
    .get_chg_current_step = oppo_rt9467_get_chg_current_step,
    .need_to_check_ibatt = oppo_rt9467_need_to_check_ibatt,
    .get_dyna_aicl_result = oppo_rt9467_get_dyna_aicl_result,
    .get_shortc_hw_gpio_status = oppo_rt9467_get_shortc_hw_gpio_status,
//	void (*check_is_iindpm_mode) (void);
    .oppo_chg_get_pd_type = oppo_rt9467_get_pd_type,
    .oppo_chg_pd_setup = oppo_rt9467_pd_setup,
	.get_charger_subtype = oppo_rt9467_get_charger_subtype,
	.set_qc_config = oppo_rt9467_set_qc_config,
	.enable_qc_detect = oppo_rt9467_enable_qc_detect,
//#ifdef ODM_WT_EDIT
		//Junbo.Guo@ODM_WT.BSP.CHG, 2019/11/11, Modify for pe20
	.oppo_chg_get_pe20_type = oppo_rt9467_chg_get_pe20_type,
	.oppo_chg_pe20_setup = oppo_rt9467_chg_pe20_setup,
