...
void oppo_rt9471_dump_registers(void)
{
	__rt9471_dump_registers(rt9471);
}

int oppo_rt9471_kick_wdt(void)
{
	return __rt9471_kick_wdt(rt9471);
}

int oppo_rt9471_set_ichg(int cur)
{
	u32 uA = cur*1000;
#ifdef ODM_WT_EDIT
		//Junbo.Guo@ODM_WT.BSP.CHG, 2019/11/11, Modify for subcharger
...
void oppo_rt9471_set_mivr(int vbatt)
{
...
int oppo_rt9471_set_aicr(int current_ma)
{
	int rc = 0, i = 0;
	int chg_vol = 0;
	int aicl_point = 0;
...
int oppo_rt9471_set_cv(int cur)
{
	u32 uV = cur*1000;
	return __rt9471_set_cv(rt9471, uV);
}

int oppo_rt9471_set_ieoc(int cur)
{
	u32 uA = cur*1000;
	return __rt9471_set_ieoc(rt9471, uA);
}

int oppo_rt9471_charging_enable(void)
{
	return __rt9471_enable_charging(rt9471, true);
}

int oppo_rt9471_charging_disable(void)
{
...
int oppo_rt9471_hardware_init(void)
{
	int ret = 0;
...
int oppo_rt9471_is_charging_enabled(void)
{
	bool en;
...
int oppo_rt9471_is_charging_done(void)
{
	int ret = 0;
	enum rt9471_ic_stat ic_stat = RT9471_ICSTAT_SLEEP;
...
int oppo_rt9471_enable_otg(void)
{
	int ret = 0;
...
int oppo_rt9471_disable_otg(void)
{
	int ret = 0;
...
int oppo_rt9471_disable_te(void)
{
	return __rt9471_enable_te(rt9471, false);
}

int oppo_rt9471_get_chg_current_step(void)
{
	return RT9471_ICHG_STEP;
}

int oppo_rt9471_get_charger_type(void)
{
	return charger_type;
}

int oppo_rt9471_charger_suspend(void)
{
	return 0;
}

int oppo_rt9471_charger_unsuspend(void)
{
	return 0;
}

int oppo_rt9471_set_rechg_vol(int vol)
{
	return 0;
}

int oppo_rt9471_reset_charger(void)
{
	return 0;
}

bool oppo_rt9471_check_charger_resume(void)
{
	return true;
}

void oppo_rt9471_set_chargerid_switch_val(int value)
{
	return;
}

int oppo_rt9471_get_chargerid_switch_val(void)
{
	return 0;
}
...
bool oppo_rt9471_need_to_check_ibatt(void)
{
	return false;
}
int oppo_rt9471_get_dyna_aicl_result(void)
{
	u32 uA;
	int mA = 0;
...
bool oppo_rt9471_get_shortc_hw_gpio_status(void)
{
	return false;
}

struct oppo_chg_operations  oppo_chg_rt9471_ops = {
	.dump_registers = oppo_rt9471_dump_registers,
	.kick_wdt = oppo_rt9471_kick_wdt,
	.hardware_init = oppo_rt9471_hardware_init,
	.charging_current_write_fast = oppo_rt9471_set_ichg,
	.set_aicl_point = oppo_rt9471_set_mivr,
	.input_current_write = oppo_rt9471_set_aicr,
	.float_voltage_write = oppo_rt9471_set_cv,
	.term_current_set = oppo_rt9471_set_ieoc,
	.charging_enable = oppo_rt9471_charging_enable,
	.charging_disable = oppo_rt9471_charging_disable,
	.get_charging_enable = oppo_rt9471_is_charging_enabled,
	.charger_suspend = oppo_rt9471_charger_suspend,
	.charger_unsuspend = oppo_rt9471_charger_unsuspend,
	.set_rechg_vol = oppo_rt9471_set_rechg_vol,
	.reset_charger = oppo_rt9471_reset_charger,
	.read_full = oppo_rt9471_is_charging_done,
	.otg_enable = oppo_rt9471_enable_otg,
	.otg_disable = oppo_rt9471_disable_otg,
	.set_charging_term_disable = oppo_rt9471_disable_te,
	.check_charger_resume = oppo_rt9471_check_charger_resume,

	.get_charger_type = oppo_rt9471_get_charger_type,
	.get_charger_volt = battery_meter_get_charger_voltage,
//	int (*get_charger_current)(void);
	.get_chargerid_volt = NULL,
    .set_chargerid_switch_val = oppo_rt9471_set_chargerid_switch_val,
    .get_chargerid_switch_val = oppo_rt9471_get_chargerid_switch_val,
    ...
    .get_chg_current_step = oppo_rt9471_get_chg_current_step,
    .need_to_check_ibatt = oppo_rt9471_need_to_check_ibatt,
    .get_dyna_aicl_result = oppo_rt9471_get_dyna_aicl_result,
    .get_shortc_hw_gpio_status = oppo_rt9471_get_shortc_hw_gpio_status,
