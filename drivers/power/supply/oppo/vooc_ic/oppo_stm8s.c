...
**    Modify for vooc batt 4.40   */
	...
	if (chip->vooc_fw_type == VOOC_FW_TYPE_STM8S_4400_AVOID_FAKE_ADAPTER) {
	...
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_STM8S_4450_FFC){
	...
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_STM8S_4400_SVOOC_6500MA) {
		...
		chg_err("tongfeng test svooc 6500mA \n");
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_STM8S_4450_FFC_5V6A) {
