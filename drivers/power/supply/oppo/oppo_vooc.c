...
//		snprintf(chip->fw_path, MAX_FW_NAME_LENGTH, "fastchg/%d/oppo_vooc_fw.bin", get_project());	modify
		snprintf(chip->fw_path, MAX_FW_NAME_LENGTH, "fastchg/18531/oppo_vooc_fw.bin");
	} else {
//		snprintf(chip->fw_path, MAX_FW_NAME_LENGTH, "fastchg/%d/oppo_vooc_fw_n76e.bin", get_project());
		snprintf(chip->fw_path, MAX_FW_NAME_LENGTH, "fastchg/18531/oppo_vooc_fw_n76e.bin");
	}
