...
static const char sia8101_palyback_defaults[] = {
...
static const char sia8101_voice_defaults[] = {
				0x0C,		//SIA8101_REG_MOD_CFG
				0xE5,		//SIA8101_REG_SYS_EN
				0xD6,		//SIA8101_REG_X_DATA_A
				0x55,		//SIA8101_REG_X_DATA_B
...
const struct sia81xx_reg_default_val sia8101_reg_default_val = {
	...
	.reg_defaults[AUDIO_SCENE_PLAYBACK] = {
		.vals = sia8101_palyback_defaults,
		.num = ARRAY_SIZE(sia8101_palyback_defaults)
	},
	.reg_defaults[AUDIO_SCENE_VOICE] = {
		.vals = sia8101_voice_defaults,
		.num = ARRAY_SIZE(sia8101_voice_defaults)
	}
};
	...
	struct regmap *regmap) 
{
	...
	if(0 != sia81xx_regmap_read(regmap, SIA8101_REG_CHIP_ID, 1, (char *)&val))
		return -1;
    
    pr_info("[info][%s] %s: val = %x \r\n", LOG_FLAG, __func__, val);

	if((SIA8101_CHIP_ID_VAL &SIA8101_CHIP_ID_MASK) 
        != (val & SIA8101_CHIP_ID_VAL))
		return -1;
